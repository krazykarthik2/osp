...
OBJS := build/boot64.o build/kernel.o build/terminal.o build/serial.o build/keyboard.o build/shell.o build/mmu.o
...
test: $(ISO)
	timeout 8s qemu-system-x86_64 -cdrom $(ISO) -serial stdio -display none -no-reboot -monitor none > build/qemu.log 2>&1 || true
